...
unsigned int get_year();
	...
	int info_JEPG(struct DLL_STRPICENV *env, int *info, int size, unsigned char *fp);
	int decode0_JEPG(struct DLL_STRPICENV *env, int size, unsigned char *fp, int b_type, unsigned char *buf, int skip);
